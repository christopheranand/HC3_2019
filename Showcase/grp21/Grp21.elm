...
module Grp21 exposing (Model, Msg(..), authors, init, keywords, title, update, view)

-- change to your group number TODO

import WebSlot21 as WebSlot
...
authors : List String
authors =
    [ "Ibrahim Malik", "Emilio Hajj", "Michelle Leung", "Justin Zhou"  ]
